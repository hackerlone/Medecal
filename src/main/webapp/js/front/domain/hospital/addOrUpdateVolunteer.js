...
function saveData(){
	...
	var obj = {id:nurseId,username:username,sex:sex,phone:phone,email:email,avatar:filePaths,
			address:address,province:province,city:city,weixin:weixin,qq:qq};
	lh.post("front", "/hospital/addOrUpdateVolunteerForHospital", obj, function(rsp){
		if(rsp.status == 'success'){
			lh.jumpToUrl('/hospital/hospitalVolunteerList');
		}else{
			lh.alert(rsp.msg);
		}
	}, "json");
