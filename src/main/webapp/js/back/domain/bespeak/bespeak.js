...
function loadGrid(){
	lh.$grid.datagrid({
		...
		[
			...
			{field:'bespeakTime',title:'预约时间',width:120,align:'center',formatter: function(value,row,index){
	        	return lh.formatGridDate(value);
	        }},
	        {field:'baseCondition',title:'基本病情',width:120,align:'center'},
	        {field:'isRegisterAgent',title:'是否代理挂号',width:120,align:'center',formatter: function(value,row,index){
	        	return value == 1 ? '<span style="color:orange">是</span>' : '';
	        }},//1.挂号，2.陪诊，3.血液检测,4.体检
