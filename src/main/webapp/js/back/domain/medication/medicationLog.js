...
function loadGrid(){
	lh.$grid.datagrid({
		...
		[
			...
			{field:'medicationName',title:'药物名称',width:120,align:'center'},
			{field:'inOrOut',title:'入库或出库',width:120,align:'center',formatter: function(value,row,index){
	        	return value == 1 ? '<span style="color:orange">出库</span>' : '入库';
	        }},
			{field:'inOrOutTime',title:'入库或出库时间',width:120,align:'center',formatter: function(value,row,index){
