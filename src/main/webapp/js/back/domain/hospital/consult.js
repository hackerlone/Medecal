...
function loadGrid(){
	lh.$grid.datagrid({
		...
		[
	        ...
	        {field:'username',title:'咨询人姓名',width:120,align:'center'},
	        {field:'doctorName',title:'咨询医生姓名',width:120,align:'center'},
	        {field:'title',title:'标题',width:120,align:'center'},
	        {field:'mainContent',title:'咨询内容',width:120,align:'center'},
	        {field:'helpContent',title:'请求帮助的内容',width:120,align:'center'},
