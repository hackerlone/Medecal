...
<body>
    ...
    <div id="mainObjWindiv" style="display:none;">
	     <div id='mainObjWin' class="easyui-window" title="用户信息" style="width: 635px;" data-options="modal:true,closed:true,maximizable:false,collapsible:false,minimizable:false">
			<div id="mainObjTip"></div>
	         <form id="mainObjForm"><br/>
	       		 <table id="mainObjTable" class="padL5">
					<tbody>
						<tr class="tr_ht" align="right">
							<td class="td_pad"><span><span style="color:red;font-weight:bolder;">*</span>用户用户名：</span><input role="textbox" id="f_username" class="domain-input easyui-textbox width100" data-options="required:true"/></td>
							<td class="td_pad"><span><span style="color:red;font-weight:bolder;">*</span>用户真实姓名：</span><input role="textbox" id="f_realName" class="domain-input easyui-textbox width100" data-options="required:true"/></td>
							<td class="td_pad"><span><span style="color:red;font-weight:bolder;">*</span>身份证号码：</span><input role="textbox" id="f_idcardNum" class="domain-input easyui-textbox width100" data-options="required:true"/></td>
						</tr>
						<tr class="tr_ht" align="right">
						...
						<tr class="tr_ht" align="right">
							<td class="td_pad"><span>手机：</span><input role="textbox" id="f_phone" class="domain-input easyui-textbox width100" data-options="required:false"/></td>
	...
	<script type="text/javascript" src="/js/back/domain/user/patient.js" title="v"></script>
</body>
</html>