...
<body>
   	...
   	<table id="mainQueryTable">
		<tbody>
			<tr class="tr_ht" align="right">
				<td class="td_pad"><span>用户名：</span><input role="textbox" id="sc_patientName" class="domain-input easyui-textbox width140" /></td>
			...
			<tr class="tr_ht" align="right">
				<td class="td_pad"><span>艾迪康编号：</span><input role="textbox" id="sc_adiconBarcodeLike" class="domain-input easyui-textbox width140" /></td>
				<td class="td_pad"><span>性别：</span><input role="combobox" id="sc_sex" class="domain-input easyui-combobox width140" /></td>
	...
	<!-- <div id="opt_outer_div">
		<div class="fl_opt_div">
			...
			<button  onclick="exportPatient()" class="button button-primary button-rounded button-small">导出患者信息</button>
	...
	<div id="mainObjWindiv" style="display:none;margin:20px;">
	     <div id='mainObjWin' class="easyui-window" title="血液检测" style="width: 680px;" data-options="modal:true,closed:true,maximizable:false,collapsible:false,minimizable:false">
			<div id="mainObjTip"></div>
	         <form id="mainObjForm"><br/>
	       		 <table id="mainObjTable" class="padL5">
					<tbody>
						<tr class="tr_ht" align="right">
							<td class="td_pad"><span><span style="color:red;font-weight:bolder;">*</span>条形码：</span><input role="textbox" id="f_adiconBarcode" class="domain-input easyui-textbox width140" data-options="required:true"/></td>
							<td class="td_pad"><span><span style="color:red;font-weight:bolder;">*</span>用户：</span><input role="combobox" id="f_patientId" class="domain-input easyui-combobox width140" data-options="required:true"/></td>
						...
						<tr class="tr_ht" align="right">
							<td class="td_pad"><span style="color:gray;">身份证号：</span><input role="textbox" id="f_patientIdcardNum" class="domain-input easyui-textbox width140" data-options="required:false"/></td>
							<td class="td_pad"><span style="color:gray;">患者姓名：</span><input role="textbox" id="f_patientName" class="domain-input easyui-textbox width140" data-options="required:false"/></td>
							<td class="td_pad"><span style="color:gray;">电话号码：</span><input role="textbox" id="f_patientPhone" class="domain-input easyui-textbox width140" data-options="required:false"/></td>
						...
						<tr class="tr_ht" align="right">
							<td class="td_pad"><span style="color:gray;">用户性别：</span><input role="combobox" id="f_patientSex" class="domain-input easyui-combobox width140" data-options="required:false"/></td>
							<td class="td_pad"><span style="color:gray;">用户职业：</span><input role="combobox" id="f_patientJob" class="domain-input easyui-combobox width140" data-options="required:false"/></td>
						...
						<tr class="tr_ht" align="right">
							<td class="td_pad" colspan="3"><span><span style="color:red;font-weight:bolder;">*</span>检测项：</span><input role="combobox" id="f_itemCodes" class="domain-input easyui-combobox width140" data-options="multiple:true,required:false,height:40,multiline:true,width:580"/></td>
						</tr>
					</tbody>
				 </table>
			 </form>  
	...
	<script type="text/javascript" src="/js/back/domain/user/patientReport.js" title="v"></script>
</body>
</html>