...
<body>
	     ...
	     <div id='mainObjWin' class="easyui-window" title="添加药品" style="width: 635px;" data-options="modal:true,closed:true,maximizable:false,collapsible:false,minimizable:false">
			<div id="mainObjTip"></div>
	         <form id="mainObjForm"><br/>
					...
					<tbody>
						<tr class="tr_ht" align="right">
							<td class="td_pad"><span>短语名称：</span><input role="textbox" id="f_name" class="domain-input easyui-textbox width100" data-options="required:true"/></td>
	...
	<script type="text/javascript" src="/js/back/domain/user/regularRemind.js" title="v"></script>
</body>
</html>