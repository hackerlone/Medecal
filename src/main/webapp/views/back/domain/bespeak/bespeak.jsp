...
<body>
   	...
   	<table id="mainQueryTable">
		<tbody>
			<tr class="tr_ht" align="right">
				<td class="td_pad"><span>预约时间：</span><input role="datebox" id="sc_bespeakTime" class="domain-input easyui-datebox width100" /></td>
				<td class="td_pad"><span>是否代为远程诊疗：</span><input role="combobox" id="sc_isRegisterAgent" class="domain-input easyui-combobox width100" /></td>
			...
			<tr class="tr_ht" align="right">
				...
				<td class="td_pad"><span>类型：</span><input role="combobox" id="sc_typeId" class="domain-input easyui-combobox width100" /></td>
    ...
    <div id="mainObjWindiv" style="display:none;">
	     <div id='mainObjWin' class="easyui-window" title="添加预约" style="width: 635px;" data-options="modal:true,closed:true,maximizable:false,collapsible:false,minimizable:false">
			<div id="mainObjTip"></div>
	         <form id="mainObjForm"><br/>
	       		 <table id="mainObjTable" class="padL5">
					<tbody>
						<tr class="tr_ht" align="right">
							<td class="td_pad"><span><span style="color:red;font-weight:bolder;">*</span>预约时间：</span><input role="datetimebox" id="f_bespeakTime" class="domain-input easyui-datetimebox width100" data-options="required:true"/></td>
							<td class="td_pad"><span><span style="color:red;font-weight:bolder;">*</span>类型：</span><input role="combobox" id="f_typeId" class="domain-input easyui-combobox width100" data-options="required:true"/></td>
							<td class="td_pad"><span>医生：</span><input role="combobox" id="f_doctorId" class="domain-input easyui-combobox width100" data-options="required:false"/></td>
						</tr>
						<tr class="tr_ht" align="right">
							<td class="td_pad"><span>是否代为远程诊疗：</span><input role="combobox" id="f_isRegisterAgent" class="domain-input easyui-combobox width100" /></td>
							<td class="td_pad"><span>状态：</span><input role="combobox" id="f_mainStatus" class="domain-input easyui-combobox width100" data-options="required:false"/></td>
						</tr>
						<tr class="tr_ht" align="right">
							<td class="td_pad" colspan="3"><span>基本病情：</span><input role="textbox" id="f_baseCondition" class="domain-input easyui-textbox width100" data-options="required:false,multiline:true,height:100,width:500"/></td>
						</tr>
					</tbody>
				 </table>
			 </form>  
	...
	<script type="text/javascript" src="/js/back/domain/bespeak/bespeak.js" title="v"></script>
</body>
</html>