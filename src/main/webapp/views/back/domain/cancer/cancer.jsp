...
<body>
   	...
   	<table id="mainQueryTable">
		<tbody>
			<tr class="tr_ht" align="right">
				<td class="td_pad"><span>血液检测项目名称：</span><input role="textbox" id="sc_name" class="domain-input easyui-textbox width100" /></td>
    ...
    <div id="mainObjWindiv" style="display:none;">
	     <div id='mainObjWin' class="easyui-window" title="添加血液检测项目" style="width: 635px;" data-options="modal:true,closed:true,maximizable:false,collapsible:false,minimizable:false">
			<div id="mainObjTip"></div>
	         <form id="mainObjForm"><br/>
	       		 <table id="mainObjTable" class="padL5">
					<tbody>
						<tr class="tr_ht" align="right">
							<td class="td_pad"><span><span style="color:red;font-weight:bolder;">*</span>血液检测项目名称：</span><input role="textbox" id="f_name" class="domain-input easyui-textbox width100" data-options="required:true"/></td>
							<td class="td_pad"><span><span style="color:red;font-weight:bolder;">*</span>血液检测项目代码：</span><input role="textbox" id="f_code" class="domain-input easyui-textbox width100" data-options="required:true"/></td>
	...
	<script type="text/javascript" src="/js/back/domain/cancer/cancer.js" title="v"></script>
</body>
</html>