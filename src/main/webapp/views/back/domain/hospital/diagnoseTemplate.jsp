...
<body>
    ...
    <div id="mainObjWindiv" style="display:none;">
	     <div id='mainObjWin' class="easyui-window" title="病历模板信息" style="width: 635px;" data-options="modal:true,closed:true,maximizable:false,collapsible:false,minimizable:false">
			<div id="mainObjTip"></div>
	         <form id="mainObjForm"><br/>
	       		 <table id="mainObjTable" class="padL5">
					<tbody>
						<tr class="tr_ht" align="right">
							<td class="td_pad"><span>诊所：</span><input role="combobox" id="f_hospitalId" class="domain-input easyui-combobox width100" data-options="required:true"/></td>
							...
							<td class="td_pad"><span>就诊日期：</span><input role="datetimebox" id="f_diagnoseTime" class="domain-input easyui-datetimebox width100" data-options="required:true"/></td>
						</tr>
						<tr class="tr_ht" align="right">
							<td class="td_pad"><span>状态：</span><input role="combobox" id="f_mainStatus" class="domain-input easyui-combobox width140"/></td>
						</tr>
						<tr class="tr_ht" align="right">
							<td class="td_pad" colspan="3"><span>过敏历史：</span><input role="textbox" id="f_allergyHistory" class="domain-input easyui-textbox width100" data-options="required:true,multiline:true,height:100,width:500"/></td>
						</tr>
						<tr class="tr_ht" align="right">
							<td class="td_pad" colspan="3"><span>基本病情：</span><input role="textbox" id="f_baseCondition" class="domain-input easyui-textbox width100" data-options="required:true,multiline:true,height:100,width:500"/></td>
						</tr>
						<tr class="tr_ht" align="right">
							<td class="td_pad" colspan="3"><span>诊断结果：</span><input role="textbox" id="f_diagnoseTags" class="domain-input easyui-textbox width100" data-options="required:true,multiline:true,height:100,width:500"/></td>
						</tr>
					</tbody>
				 </table>
			 </form>  
	...
	<script type="text/javascript" src="/js/back/domain/hospital/diagnoseTemplate.js" title="v"></script>
</body>
</html>