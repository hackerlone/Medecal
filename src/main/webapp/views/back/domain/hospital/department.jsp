...
<body>
   	...
   	<table id="mainQueryTable">
		<tbody>
			<tr class="tr_ht" align="right">
				<td class="td_pad"><span>科室名称：</span><input role="textbox" id="sc_name" class="domain-input easyui-textbox width140" /></td>
    ...
    <div id="mainObjWindiv" style="display:none;">
	     <div id='mainObjWin' class="easyui-window" title="诊所信息" style="width: 635px;" data-options="modal:true,closed:true,maximizable:false,collapsible:false,minimizable:false">
	         ...
	         <form id="mainObjForm"><br/>
					...
					<tbody>
						<tr class="tr_ht" align="right">
							...
							<td class="td_pad"><span>科室名称：</span><input role="textbox" id="f_name" class="domain-input easyui-textbox width100" data-options="required:true"/></td>
						</tr>
						<tr class="tr_ht" align="right">
							<td class="td_pad"><span>上级科室：</span><input role="textbox" id="f_parentId" class="domain-input easyui-textbox width100" data-options="required:true"/></td>
	...
	<script type="text/javascript" src="/js/back/domain/hospital/department.js" title="v"></script>
</body>
</html>