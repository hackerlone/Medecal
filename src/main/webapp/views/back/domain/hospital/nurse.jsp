...
<body>
	...
	<div id="opt_outer_div">
		<div class="fl_opt_div">
			...
			<!-- <button  onclick="exportDoctor()" class="button button-primary button-rounded button-small">导出护士信息</button> -->
    ...
    <div id="mainObjWindiv" style="display:none;">
	     <div id='mainObjWin' class="easyui-window" title="护士信息" style="width: 720px;" data-options="modal:true,closed:true,maximizable:false,collapsible:false,minimizable:false">
			<div id="mainObjTip"></div>
	         <form id="mainObjForm"><br/>
	       		 <table id="mainObjTable" class="padL5">
					<tbody>
						<tr class="tr_ht" align="right">
							<td class="td_pad"><span><span style="color:red;font-weight:bolder;">*</span>所属诊所：</span><input role="textbox" id="f_hospitalId" class="domain-input easyui-textbox width140" data-options="required:true"/></td>
						...
						<tr class="tr_ht" align="right">
							<td class="td_pad"><span><span style="color:red;font-weight:bolder;">*</span>身份证号码：</span><input role="textbox" id="f_idCard" class="domain-input easyui-textbox width140" data-options="required:true"/></td>
							...
							<td class="td_pad"><span><span style="color:red;font-weight:bolder;">*</span>手机：</span><input role="textbox" id="f_phone" class="domain-input easyui-textbox width140" data-options="required:false"/></td>
						</tr>
						<tr class="tr_ht" align="right">
			 ...
			 <div style="display:inline-block;float:left;">
				 <img id="pic" class="picurl" src="${pic.picPaths}" style="height:60px;max-width:100px;overflow:hidden;padding:5px;"/>
	...
	<script type="text/javascript" src="/js/back/domain/hospital/nurse.js" title="v"></script>
</body>
</html>