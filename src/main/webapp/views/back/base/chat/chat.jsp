...
<body>
    ...
    <div id="mainObjWindiv" style="display:none;">
	     <div id='mainObjWin' class="easyui-window" title="添加消息" style="width: 550px;" data-options="modal:true,closed:true,maximizable:false,collapsible:false,minimizable:false">
	...
	<script type="text/javascript" src="/js/back/base/chat/chat.js" title="v"></script>
</body>
</html>