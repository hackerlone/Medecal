...
<body>
   	...
   	<table id="mainQueryTable">
		<tbody>
			<tr class="tr_ht" align="right">
				<td class="td_pad"><span>诊所名称：</span><input role="combobox" id="sc_hospitalId" class="domain-input easyui-combobox width140" /></td>
	...
	<div id="opt_outer_div">
		<div class="fl_opt_div">
			...
			<button role="opt_1" onclick="lh.jumpToUrl('/back/addOrUpdateAnnouncementPage')" class="button button-primary button-rounded button-small">添加</button>
	...
	<script type="text/javascript" src="/js/back/base/announcement/announcement.js" title="v"></script>
</body>
</html>