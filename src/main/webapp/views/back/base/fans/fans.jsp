...
<body>
   	...
   	<table id="mainQueryTable">
		<tbody>
			<tr class="tr_ht" align="right">
				<td class="td_pad"><span>用户名：</span><input role="combobox" id="sc_userId" class="domain-input easyui-combobox width140" /></td>
			...
			<tr class="tr_ht" align="right">
				<td class="td_pad"><span>粉丝：</span><input role="combobox" id="sc_fansId" class="domain-input easyui-combobox width140" /></td>
				<td class="td_pad"></td>
    ...
    <div id="mainObjWindiv" style="display:none;">
	     <div id='mainObjWin' class="easyui-window" title="添加粉丝和好友" style="width: 550px;" data-options="modal:true,closed:true,maximizable:false,collapsible:false,minimizable:false">
			<div id="mainObjTip"></div>
	         <form id="mainObjForm"><br/>
	       		 <table id="mainObjTable" class="padL5">
					<tbody>
						<tr class="tr_ht" align="right">
							<td class="td_pad"><span><span style="color:red;font-weight:bolder;">*</span>用户名：</span><input role="combobox" id="f_userId" class="domain-input easyui-combobox width100" data-options="required:true"/></td>
							<td class="td_pad"><span><span style="color:red;font-weight:bolder;">*</span>粉丝或好友：</span><input role="combobox" id="f_fansId" class="domain-input easyui-combobox width100" data-options="required:true"/></td>
	...
	<script type="text/javascript" src="/js/back/base/fans/fans.js" title="v"></script>
</body>
</html>