...
<body>
   	...
   	<table id="mainQueryTable">
		<tbody>
			...
			<tr class="tr_ht" align="right">
				<td class="td_pad"><span>评论人：</span><input role="combobox" id="sc_userId" class="domain-input easyui-combobox width140" /></td>
    ...
    <div id="mainObjWindiv" style="display:none;">
	     <div id='mainObjWin' class="easyui-window" title="添加评论" style="width: 550px;" data-options="modal:true,closed:true,maximizable:false,collapsible:false,minimizable:false">
			<div id="mainObjTip"></div>
	         <form id="mainObjForm"><br/>
	       		 <table id="mainObjTable" class="padL5">
					<tbody>
						<tr class="tr_ht" align="right">
							<td class="td_pad"><span>评论人：</span><input role="combobox" id="f_userId" class="domain-input easyui-combobox width100" data-options="required:true"/></td>
	...
	<script type="text/javascript" src="/js/back/base/comment/comment.js" title="v"></script>
</body>
</html>