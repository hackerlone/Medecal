...
<body>
	...
	<!-- 表格  结束 -->
     <div id="mainObjWindiv" style="display:none;">
	     <div id='mainObjWin' class="easyui-window" title="数据字典" style="width: 640px;" data-options="modal:true,closed:true,maximizable:false,collapsible:false,minimizable:false">
			<div id="mainObjTip">数据字典对系统的正常运行至关重要，请谨慎操作！</div>
	         <form id="mainObjForm"><br/>
					...
					<tbody>
						...
						<tr class="tr_ht" align="right">
							<td class="td_pad"><span>字典值：</span><input role="textbox" id="f_dictValue" class="domain-input easyui-textbox width140" data-options="required:false"/></td>	
	...
	<script type="text/javascript" src="/js/back/base/dict/dict.js" title="v"></script>
</body>
</html>