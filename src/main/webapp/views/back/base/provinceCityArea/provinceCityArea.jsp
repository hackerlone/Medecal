...
<body>
   	...
   	<table id="mainQueryTable">
		<tbody>
			<tr class="tr_ht" align="right">
				<td class="td_pad"><span>省(直辖市)：</span><input role="combobox" id="sc_higherId" class="domain-input easyui-combobox width140" /></td>
			...
			<tr class="tr_ht" align="right">
				<td class="td_pad"><span>名称：</span><input role="textbox" id="sc_areaName" class="domain-input easyui-textbox width140" /></td>
				<td class="td_pad"></td>
    ...
    <div id="mainObjWindiv" style="display:none;">
	     <div id='mainObjWin' class="easyui-window" title="添加省市区信息" style="width: 550px;" data-options="modal:true,closed:true,maximizable:false,collapsible:false,minimizable:false">
			<div id="mainObjTip"></div>
	         <form id="mainObjForm"><br/>
	       		 <table id="mainObjTable" class="padL5">
					<tbody>
						<tr class="tr_ht" align="right">
							<td class="td_pad"><span>省(直辖市)：</span><input role="combobox" id="f_higherId" class="domain-input easyui-combobox width100" data-options="required:true"/></td>
							<td class="td_pad"><span>市(县)名称：</span><input role="textbox" id="f_areaName" class="domain-input easyui-textbox width100" data-options="required:true"/></td>
	...
	<script type="text/javascript" src="/js/back/base/provinceCityArea/provinceCityArea.js" title="v"></script>
</body>
</html>