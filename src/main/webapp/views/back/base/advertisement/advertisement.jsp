...
<body>
   	...
   	<table id="mainQueryTable">
		<tbody>
			<tr class="tr_ht" align="right">
				<td class="td_pad"><span>名称：</span><input role="combobox" id="sc_title" class="domain-input easyui-combobox width140" /></td>
	...
	<div id="opt_outer_div">
		<div class="fl_opt_div">
			...
			<button role="opt_1" onclick="lh.jumpToUrl('/back/addOrUpdateAdvertisementPage')" class="button button-primary button-rounded button-small">添加</button>
	...
	<script type="text/javascript" src="/js/back/base/advertisement/advertisement.js" title="v"></script>
</body>
</html>