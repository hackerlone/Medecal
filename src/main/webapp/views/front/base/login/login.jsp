...
<body>
	...
	<div class="pz_main">
		<div class="w_1000">
	    	<div class="c_1100_10">当前位置：<a href="/">首页</a> - <a href="/login">登录</a></div>
	        <div class="c_1100_12">
	        	<div class="l_720">
	            ...
	            <div class="r_378">
	            	<div class="t_345">
	                	<span>登录</span>
	                	<button style="margin-left:200px;margin-top:3px;" type="button" onclick="loginQuickly();" class="btn btn-success">快速登陆</button>
	                </div>
	                <div class="d_345">
	                	<table cellpadding="0" cellspacing="0" border="0" width="345">
	                        ...
	                        <tr height="65" valign="bottom">
	                        	<td width="83">&nbsp;</td>
	                            <td width="15">&nbsp;</td>
	                            <td width="247" colspan="2"><input type="submit" onclick="doMobileLogin()" class="input12" value="登录会员" /> <a href="javascript:;" style=" float:left; margin-left:57px; color:#818181; line-height:35px;">忘记密码？</a></td>
	                        </tr>
	                    </table>
	                </div>
	            </div>
	...
	<script type="text/javascript" src="/js/front/base/login/login.js" title="v"></script>
</body>
</html>