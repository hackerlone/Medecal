...
<body>
                ...
                <div class="l_849">
                	<table cellpadding="0" cellspacing="0" border="0" width="773">
                        <tr height="50" valign="bottom">
                        	<td width="67" style="line-height:30px;"><span style="color:red;font-weight:bolder;">*</span>护士昵称</td>
                            <td width="310"><input type="text" class="input14" id="username" value="${nurse.username}"/></td>
                        	<td width="80" style="line-height:30px;"><span style="color:red;font-weight:bolder;">*</span>护士真实姓名</td>
                            <td width="310"><input type="text" class="input14" id="realName" value="${nurse.realName}"/></td>
                        </tr>
                        <tr height="50" valign="bottom">
                        	<td width="67" style="line-height:30px;">护士联系地址</td>
                        ...
                        <tr height="48" valign="bottom">
                             ...
                             <select class="input8" id="province" onChange="provinceChange()" style="width: 268px;">
								<c:forEach var="province" items="${provinceCityAreaList}">	                                	
                             		<option value="${province.id}" <c:if test="${province.id == nurse.province}">selected="selected"</c:if>>${province.areaName}</option>
                             	</c:forEach>
                             </select>
                             </td>
                        ...
                        <tr height="50" valign="bottom">
                            ...
                            <td width="310"><input type="text" class="input14" id="idcardNum" value="${nurse.idcardNum}"/></td>
	...
	<script type="text/javascript" src="/js/front/domain/hospital/addOrUpdateNurse.js" title="v"></script>
</body>
</html>
