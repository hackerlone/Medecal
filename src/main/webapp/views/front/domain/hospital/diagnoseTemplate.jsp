...
<body>
	    	...
	    	<%@ include file="/views/front/common/hospital/hospitalLeft.htm" %><!--左边导航 -->
	         <div class="w_851">
	        	<div class="c_851">
            		...
            		<div class="d_851_1">
		            	<table cellpadding="0" cellspacing="0" border="0" width="849" id="diagnoseTemplateList">
		                </table>
		            </div>
		            <div class="fy_new">
	...
	<script type="text/javascript" src="/js/front/domain/hospital/diagnoseTemplate.js" title="v"></script>
