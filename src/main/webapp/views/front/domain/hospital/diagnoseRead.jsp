...
<body>
	                ...
	                <div class="l_849">
	                	<table cellpadding="0" cellspacing="0" border="0" width="773">
	                        ...
	                        <tr height="50" valign="bottom">
	                            ...
	                            <td width="310"><input type="text" class="input14" readonly="readonly" value="${diagnose.patientSexName}"/></td>
	                        </tr>
	                        ...
	                        <tr height="92" valign="bottom">
								<td colspan="4" width="706" style="text-align:center;padding-right:60px;">
									<span style="color:black;">价格合计：
										<input id="totalPrice" type="number" value="${diagnose.medicalTotalPrice}" readonly="readonly" style="border: none;width: 80px;text-align: center;line-height: 20px;">
									</span> 元
								</td>
							</tr>
	...
	<script type="text/javascript" src="/js/front/domain/hospital/diagnoseRead.js" title="v"></script>
</body>
</html>
