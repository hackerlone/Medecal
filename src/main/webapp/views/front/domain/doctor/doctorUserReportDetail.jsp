...
<body>
						...
						<table cellpadding="0" cellspacing="0" border="0" width="773" id="baseInformation">
							...
							<tr height="92" valign="bottom">
								...
								<td colspan="3" width="706" style="text-align: center;">
									<button onclick="saveDoctorResult();" type="button" class="btn btn-success" style="margin-right: 80px;line-height: 27px;padding: 6px 50px;">保存</button>
									<button style="margin-right: 80px;padding: 6px 50px;line-height: 27px;" type="button" onclick="lh.back();" class="btn btn-success">返回</button>
								</td>
							</tr>
						</table>
					</div>
	...
	<script type="text/javascript" src="/js/front/domain/doctor/doctorUserReportDetail.js" title="v"></script>
