...
<body>
	                ...
	                <div class="l_849">
	                	<table cellpadding="0" cellspacing="0" border="0" width="773">
	                		<tr height="40" valign="bottom">
	                            ...
	                            <td colspan="3" width="706"><input style="width:695px;" type="text" class="input16"  id="templateName" value="${dt.templateName}"/></td>
	                        </tr>
	                        <tr height="40" valign="bottom">
	                        	<td width="67" style="line-height:30px;">过敏历史</td>
	                            <td colspan="3" width="706"><input style="width:695px;" type="text" class="input16"  id="allergyHistory" value="${dt.allergyHistory}"/></td>
	                        </tr>
	                        <tr height="93" valign="bottom">
	                        	<td width="67" style="line-height:50px;" valign="top">基本病情</td>
	                            <td colspan="3" width="706"><textarea style="width:695px;" class="text_input"  id="baseCondition">${dt.baseCondition}</textarea></td>
	                        </tr>
	                        <tr height="40" valign="bottom">
	                        ...
	                        <tr height="92" valign="bottom">
	                            ...
	                            <td colspan="3" width="706" style="text-align:center;">
	                            	<button style="margin-right:80px;" type="button" onclick="saveDiagnoseTemplate(${dt.id});" class="btn btn-info">保存</button>
	...
	<script type="text/javascript" src="/js/front/domain/doctor/diagnoseTemplate.js" title="v"></script>
