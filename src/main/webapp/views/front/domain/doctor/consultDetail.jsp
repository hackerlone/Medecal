...
<body>
	        	...
	        	<div class="c_851">
	                ...
	                <div class="l_849">
	                	...
	                	<table cellpadding="0" cellspacing="0" border="0" width="773">
	                        ...
	                        <tr height="93" valign="bottom" id="replyTr" <c:if test="${empty consult.replyContent}"> style="display:none"</c:if>>
	                        	<td width="67" style="line-height:50px;" valign="top">回复内容</td>
	                            <td colspan="3" width="706"><textarea <c:if test="${!empty consult.replyContent}"> readonly="readonly" </c:if> class="text_input" id="content">${consult.replyContent}</textarea></td>
	                        </tr>
	...
	<script type="text/javascript" src="/js/front/domain/doctor/consultDetail.js" title="v"></script>
</body>
</html>
